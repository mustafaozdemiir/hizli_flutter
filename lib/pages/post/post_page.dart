                            ...
                            child: Obx(
                              () => AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: (favoriteController.isFavPostList[s.postList![index].id] ?? false)
                                          ? Colors.red.shade100
                                  ...
                                  child: Center(
                                    child: (favoriteController.isFavPostList[s.postList![index].id] ?? false)
                                        ? Icon(
                                      Icons.favorite,
                                      color: Colors.red,
                                    )
                            ...
                            child: Obx(
                              () => AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(12),
                                    border: Border.all(
                                      color: (favoriteController.isFavPostList[_searchList[index].id] ?? false)
                                          ? Colors.red.shade100
                                          : Colors.grey.shade300,
                                    )
                                    ,
                                  ...
                                  child: Center(
                                    child: (favoriteController.isFavPostList[_searchList[index].id] ?? false)
                                        ? Icon(
                                      Icons.favorite,
                                      color: Colors.red,
                                    )
