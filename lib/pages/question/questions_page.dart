    ...
    return GetBuilder<QuestionController>(
        ...
        builder: (s) {
          if (questionController != null &&
              questionController.soruListe != null &&
              questionController.soruListe.isNotEmpty &&
              questionController.soruListe.length > 1 &&
              questionController.soruNo.value <
                  questionController.soruListe.length) {
            questionController.startTimer(questionController
                .soruListe[questionController.soruNo.value].time);
          }
          QuestionBanner questionBanner = QuestionBanner();
          return questionController != null &&
              questionController.soruListe != null
              ? s.soruListe.length > 1 &&
            ...
            return Column(
              children: [
                Banner(
                  ...
                  textStyle: TextStyle(
                      color: questionBanner.bannerTextColor),
                  child: Card(
              ...
              : Center(
            child: Text('Eklenmiş soru bulunamadı'),
          )
