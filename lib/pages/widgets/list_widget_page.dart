...
class _ListWidgetPageState extends State<ListWidgetPage> {
  ...
  late List<WidgetModel> _liste;
  late List<WidgetModel> _arananliste;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<WidgetModelController>(
        initState: (_) {
          widgetModelController.getWidgetsApi();
        },
        builder: (s) {
          return widgetModelController.widgetList != null
              ? s.widgetList!.isEmpty
              ? Center(
  ...
  Widget _searchListView(WidgetModelController s) {
    _liste = s.widgetList!;
    _arananliste = _liste.where((item) {
  ...
  Widget _searchAddList(WidgetModelController s) {
    return Expanded(
      child: ListView.builder(
          ...
          itemBuilder: (context, int index) {
            Widget cesit;
            switch (_arananliste[index].kind) {
              case 'Layout':
                cesit = Text(
                  _arananliste[index].kind,
                  style: TextStyle(
                    color: Colors.yellow[900]!.withOpacity(.7),
                  ),
                );
                    ...
                    Container(
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            Functions.convertToAgo(_arananliste[index].createdAt),
                            style: TextStyle(
                                color: Colors.grey.shade800, fontSize: 12),
                          )
                        ],
